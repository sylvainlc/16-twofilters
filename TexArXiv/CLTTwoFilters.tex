...
The decompositions \eqref{eq:forward-approximation} and \eqref{eq:backward-approximation} together with Theorem \ref{thm:CLT-Two-Populations} allow to prove a CLT form the forward and the backward
