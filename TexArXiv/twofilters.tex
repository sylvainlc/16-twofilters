...
\newcommand{\note}[2]{\marginpar{\textcolor{blue}{#1} \color{red}\footnotesize{ #2}\color{black}}}
...
\usepackage{geometry}
\geometry{top=3.8cm, bottom=3.8cm, left=3.8cm , right=3.8cm}
\usepackage{fancyhdr}
\pagestyle{fancy}
...
\date{}
\lhead{Nguyen et al.}
\rhead{Two-filter approximations of marginal smoothing distributions}
